            ...
            <View style={firstPageStyles.fifthPageView}>
                ...
                <View style={firstPageStyles.fifthPagePersonView}>
                    <View style={firstPageStyles.fifthPagePersonContainer}>
                        ...
                        <View style={firstPageStyles.fifthPageContainerView}>
                            <Text style={firstPageStyles.fifthPageFirstContainerText}>مرحبا بك</Text>
                ...
                <View style={firstPageStyles.fifthPageRequestContainer}>
                    ...
                    <View style={firstPageStyles.fifthPageInnerRequestContainer}>
                        <View style={firstPageStyles.fifthPageInnerRequestContainerOne}>
                            <Text style={firstPageStyles.fifthPageInnerRequestContainerFirstText}>
                                مسئول الطلب
                            </Text>
                            <Text style={firstPageStyles.fifthPageInnerRequestContainerSecondText}>
                                عادل سعيد
                            </Text>
                        </View>
                        <View style={firstPageStyles.fifthPageInnerRequestContainerTwo}>
                            <View style={firstPageStyles.fifthPageInnerRequestContainerThirdView}>
                                <Text style={firstPageStyles.fifthPageInnerRequestContainerThirdText}>
                                    تاريخ الرد
                                </Text>
                            </View>

                            <View style={firstPageStyles.fifthPageInnerRequestContainerFourthView}>
                                <Text style={firstPageStyles.fifthPageInnerRequestContainerFourthText}>
                                    Dec 18, 2019
                                </Text>
                            </View>
                        </View>
                        <View style={firstPageStyles.fifthPageInnerRequestContainerOne}>
                            <Text style={firstPageStyles.fifthPageInnerRequestContainerFithText}>
                                حالة الطلب
                            </Text>
                            <Text style={firstPageStyles.fifthPageInnerRequestContainerSixthText}>
                                مرفوض
                            </Text>
                        </View>
                    </View>
                ...
                <View style={firstPageStyles.fifthPagePersonView}>
                    <View style={firstPageStyles.fifthPagePersonContainer}>
                        ...
                        />
                        <View style={firstPageStyles.fifthPageContainerView}>
                            <Text style={firstPageStyles.fifthPagePersonFirstText}>رضا المرزوقي</Text>
                ...
                <View style={firstPageStyles.fifthPagePersonView}>
                    <View style={firstPageStyles.fifthPageIconContainer}>
                        <Image
                            source={require('../images/phoneTwo.png')}
                        />
                    </View>
                    <View style={firstPageStyles.fifthPageIconContainer}>
                ...
                <View style={firstPageStyles.fifthPageBottomView}>
                    <View style={firstPageStyles.fifthPageInnerBottomView}>
                        <View>
                            ...
                            <Text style={firstPageStyles.fifthPageFirstBottomText}>الرئيسية </Text>
                        </View>
                        <View>
                            <Image source={require('../images/order.png')} />
                            <Text style={firstPageStyles.fifthPageSecondBottomText}>الطلبات </Text>
                        </View>
                        <View>
                            <Image source={require('../images/note.png')} />
                            <Text style={firstPageStyles.fifthPageSecondBottomText} >الإشعارات </Text>
                        </View>
                        <View>
                            <Image source={require('../images/settings.png')} />
                            <Text style={firstPageStyles.fifthPageSecondBottomText}>الإعدادات </Text>
                        </View>
                    </View>
                </View>
            </View>
