          ...
          المقروء لصفحة ما سيلهي القارئ عن التركيز
           ...
           على الشكل الخارجي للنص`}
                        ...
                        <View style={firstPageStyles.secondPageViewOne}>
                            <View style={firstPageStyles.secondPageRoundedContainerOne}></View>
                            <View style={firstPageStyles.secondPageRoundedContainerTwo}></View>
                            <View style={firstPageStyles.secondPageRoundedContainerThree}></View>
