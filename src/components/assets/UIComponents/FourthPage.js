    ...
    render() {
        return (
            <View style={firstPageStyles.fourthPageView}>
                <TouchableOpacity>
                    <View style={firstPageStyles.fourthPageItemView}>
                        <Image source={require('../images/iconTwo.png')} />
                        <Text style={firstPageStyles.fourthPageSeventhText}>نسيت كلمة المرور </Text>
                    </View>
                </TouchableOpacity>
                ...
                <View style={firstPageStyles.fourthPageFirstView}>
                    <View style={firstPageStyles.fourthPageSecondView}>
                        ...
                        <View style={firstPageStyles.fourthPageMessageView}>
                            <TouchableOpacity>
                                <Text style={firstPageStyles.fourthPageMessageText}>إعادة إرسال</Text>
                    ...
                    <TouchableOpacity style={firstPageStyles.fourthPageBottom}>
                        <View style={firstPageStyles.fourthPageThirdView}>
                            <Text style={firstPageStyles.fourthPageFifthText}>إدخال الكود</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
